...
*/
$config['tables']['users']           = 'hr_users';
$config['tables']['groups']          = 'hr_groups';
$config['tables']['users_groups']    = 'hr_users_groups';
$config['tables']['login_attempts']  = 'hr_login_attempts';
 ...
 */
$config['site_title']                 = "HR System";       					// Site Title, example.com
$config['admin_email']                = "rsantor@pacificseainvests.com"; 	// Admin Email, admin@example.com
...
$config['maximum_login_attempts']     = 25;                   				// The maximum number of failed login attempts.
$config['lockout_time']               = 1;                 				// The number of seconds to lockout an account due to exceeded attempts
