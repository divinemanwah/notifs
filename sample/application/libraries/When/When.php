...
class When extends \DateTime
{
    ...
    public function __construct($params = array()/*$time = "now", $timezone = NULL*/)
    {
		$params['time'] = isset($params['time']) ? $params['time'] : 'now';
		$params['timezone'] = isset($params['timezone']) ? $params['timezone'] : null;
	
        $this->startDate = parent::__construct($params['time'], $params['timezone']);
    }
