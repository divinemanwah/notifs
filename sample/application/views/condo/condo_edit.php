    ...
    <div class="col-xs-12">
        ...
        <form id="validate_form" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input class="form-control" type="text" id="txt_condo_name" value="<?= $condo_name; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" type="text" id="txt_condo_address" value="<?= $condo_address; ?>">
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                If (Count($Condo_expat) > 0) {
                                    ...
                                    ForEach ($Condo_expat as $row) {
                                        ...
                                        echo    '                   <option value="'.$expat->mb_no.'" '. ($row->mb_no == $expat->mb_no ? "selected" : "") .'>'.$expat->mb_nick. ' ('.$expat->mb_name.')</option>';
                                                                }
                                        echo    '           </select>
                                                        </div>
                                                    </td>';
