<div class="widget-box widget-color-dark">
    <div class="widget-header">
        <h5 class="widget-title smaller">HR Records</h5>

        <div class="widget-toolbar no-border">
            <button class="btn btn-xs btn-grey" id="kpi-search-btn">
...
<!--        <div class="widget-toolbar no-border" id="mode_switch">
        ...
        <div class="widget-toolbar no-border">
            <button class="btn btn-xs btn-grey dropdown-toggle" data-toggle="dropdown" id="kpi-filter-nation-btn" data-id="0">
        ...
        <div class="widget-toolbar no-border">
            <button class="btn btn-xs btn-grey dropdown-toggle" data-toggle="dropdown" id="kpi-filter-dept-btn" data-id="0">
    ...
    <div class="widget-body">
        <div class="widget-main no-padding">
            ...
            <div class="row form-inline kpi-table-header">
                ...
                <div class="col-sm-6" >
                    <span id="maxScore" class="label label-lg label-grey arrowed-in-right arrowed-in pull-right">Maximum HR Record Score : <b id="base_score"></b></span>
                </div>
            </div>
            ...
            <div class="widget-toolbar no-border">
                <form id="exportForm" action="<?=base_url("employees/exportHrKpi")?>" method="POST">
                    ...
                    <!-- <button class="btn btn-xs btn-grey">Export</button> -->
                </form>
            </div>
