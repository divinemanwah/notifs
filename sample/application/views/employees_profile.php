	...
	<div>
		...
		<div class="width-80 label label-<?=($logged_in ? 'info' : 'grey')?> label-xlg arrowed-in arrowed-in-right">
			<div class="inline position-relative">
				<?php if($logged_in or $logged_status=='On Break'): ?>
				<i class="ace-icon fa <?=(($logged_status=='On Break')?'fa-clock-o':'fa-circle')?> light-green"></i>
				&nbsp;
				<?php endif; ?>
				<span class="white"><?=($logged_status)?></span>
			</div>
		</div>
	</div>
...
<?php if(in_array(intval($this->session->userdata('mb_deptno'), 10), array(24, 31, 22, 27, 19, 25, 20, 29, 17, 21))): ?>
...
<!-- </div> -->
		...
		<div class="page-header">
			<h1 class="center">
				<span>KPI Scores</span> <span id="kpi_year" class="editable editable-click"><?= $_curr_year ?></span>
			</h1>
		</div>
		<div class="row kpi-scores">
			<div class="col-sm-6">
				<div class="well center">
					<h5 class="smaller ligher">December  <span class="prev_year"><?= $_prev_year?></span> to May <span class="curr_year"><?= $_curr_year?></span></h5>
			...
			<div class="col-sm-6">
				<div class="well center">
					<h5 class="smaller ligher">June  <span class="curr_year"><?= $_curr_year?></span> to November  <span class="curr_year"><?= $_curr_year?></span></h5>
...
<?php if(false && in_array(intval($this->session->userdata('mb_deptno'), 10), array(24, 31, 22, 27, 19, 25, 20, 29, 17, 21))): ?>
