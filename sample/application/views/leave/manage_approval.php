<div class="col-md-12">
  <div class="widget-box widget-color-red approval-list-widget">
	<div class="widget-header">
	  <h4 class="widget-title">Leaves for Approval</h4>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="blue bigger">Leave for Approval</h4>
	  </div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="blue bigger">Leave</h4>
			</div>

			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						<h3 class="header smaller no-margin-top"><small>Leave Information - <b id="lv-requester" class="text text-info"></b></small></h3>
						<div class="row">
							<div class="form-group col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="lv-type">Leave Type : </label>
								<div class="col-sm-8">
									<select class="form-control input-sm" id="lv-type" name="lv-type" >
									</select>
								</div>
							</div>
						</div>
						<div class="row input-daterange">
							<div class="form-group col-sm-6">
								...
								<div class="col-sm-4">
									<input class="form-control input-sm input-date" disabled type="text" id="lv-date-from" name="lv-date-from" />
								</div>
							</div>
							<div class="form-group col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="lv-date-to">Date To : </label>
								<div class="col-sm-4">
									<input class="form-control input-sm input-date" disabled type="text" id="lv-date-to" name="lv-date-to" />
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row" id="mc-row">
							<div class="form-group col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="lv-mc">Med Cert Ref. No. : </label>
								<div class="col-sm-8">
				...
				<div class="row" >
				    <div class="col-sm-12" style="max-height: 120px; overflow: auto;" id="approval_list">
						None
					</div>
				</div>
			</div>
			...
			<div class="modal-footer">
				<button class="btn btn-sm btn-success modal-action-btn" id="lv-approve">
					<i class="ace-icon fa fa-check"></i>
					Approve
				</button>
				<button class="btn btn-sm btn-danger modal-action-btn" id="lv-reject">
					<i class="ace-icon fa fa-times"></i>
					Reject
				</button>
