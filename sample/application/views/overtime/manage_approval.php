<div class="col-md-12">
  <div class="widget-box widget-color-red3 approval-list-widget">
	<div class="widget-header">
	  <h4 class="widget-title">Overtimes for Approval</h4>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="blue bigger">Overtime for Approval</h4>
	  </div>
	    ...
	    <div class="row">
		  <div class="col-xs-12">
		    <div class="well">
			  ...
			  <textarea id="overtime-remarks" name="overtime-remarks" style="height: 112px; resize: none;" class="form-control limited" maxlength="250" ></textarea>
			  <br/>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="blue bigger">Overtime</h4>
			</div>

			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						<h3 class="header smaller no-margin-top"><small>Overtime Information - <b id="ot-requester" class="text text-info"></b></small></h3>
						<div class="row input-daterange">
							<div class="form-group col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="ot-date-from">Date : </label>
								<div class="col-sm-4">
									<input class="form-control input-sm input-date" disabled type="text" id="ot-date-from" name="ot-date-from" />
								</div>
							</div>
						</div>
						<div class="row">
			...
			<div class="modal-footer">
				<button class="btn btn-sm btn-success modal-action-btn" id="ot-approve">
					<i class="ace-icon fa fa-check"></i>
					Approve
				</button>
				<button class="btn btn-sm btn-danger modal-action-btn" id="ot-reject">
					<i class="ace-icon fa fa-times"></i>
					Reject
				</button>
