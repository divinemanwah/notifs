<input type="hidden" id="min_ot_min" value="<?=$settings[0]->min_overtime_min?>"/>
	...
	<div class="widget-box widget-color-dark">
		<div class="widget-header">
			...
			<div class="widget-toolbar no-border">
			  <button class="btn btn-xs btn-grey" id="add-ot-btn">
		...
		<div class="widget-body">
			<div class="widget-main no-padding">
			    <div style="overflow: auto; height: 400px; position: relative; background-color: rgb(216, 216, 216);">
				  <div id="tk-ot-loader" style="width: 20%; position: absolute; top: 42%; left: 40%; font-size: 30px; text-align: center;"><i class="ace-icon fa fa-refresh fa-spin"></i> Loading...</div>
				  <div id="tk-ot-no-record" class="hidden" style="width: 20%; position: absolute; top: 42%; left: 40%; font-size: 30px; text-align: center;"><i class="ace-icon fa fa-warning"></i> No Record Found</div>
				  <table id="tk-ot-table" class="table table-striped table-bordered table-hover" width="100%"></table>
				</div>
				<div id="tk-ot-pager"></div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="blue bigger">File Overtime</h4>
			</div>
						...
						<form class="form-horizontal" role="form" id="requestForm" novalidate="novalidate">
							...
							<div class="row">
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-4">
										<input class="form-control input-sm input-date" readonly type="text" id="ot-date-from" name="ot-date-from" value="2015-01-01"/>
									</div>
								</div>
							</div>
							<div class="row">
							    <div class="form-group col-sm-6">
									...
									<div class="col-sm-4">
									  <div class="input-group bootstrap-timepicker">
										<input class="form-control timepicker" type="text" id="ot-time-from" name="ot-time-from" />
									  </div>
									</div>
								</div>
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-4">
									  <div class="input-group bootstrap-timepicker">
										<input class="form-control timepicker" type="text" id="ot-time-to" name="ot-time-to" />
									  </div>
									</div>
								</div>
							</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="blue bigger">Overtime Application</h4>
	  </div>
	  <div class="modal-body">
	    <div class="row">
			<div class="col-xs-12">
